...
// Theme colors for dark green theme
const THEME = {
  background: '#101810',
  cardBackground: '#1c2a1c',
  headerBackground: '#253525',
  textPrimary: '#d9ffda',
      ...
      <div className="w-[1200px] h-[800px] rounded-lg flex flex-col shadow-xl" style={{ backgroundColor: THEME.background }}>
        ...
        <div className="h-12 rounded-t-lg flex items-center justify-between px-5" style={{ backgroundColor: THEME.headerBackground }}>
          <div className="flex items-center">
            ...
            <h2 className="text-xl font-bold" style={{ color: THEME.textPrimary }}>Battlefield Guide</h2>
          </div>
          <button 
            onClick={onClose}
